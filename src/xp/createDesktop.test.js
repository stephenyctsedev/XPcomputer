...
describe('createDesktop', () => {
  ...
  it('mounts five desktop icons and boots to the desktop', async () => {
    const desktop = mount();
    expect([...desktop.el.querySelectorAll('.xp-desktop-icon-label')].map((l) => l.textContent)).toEqual(['Internet Explorer', 'My Computer', 'My Documents', 'My Pictures', 'Recycle Bin']);
